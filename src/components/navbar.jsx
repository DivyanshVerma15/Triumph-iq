...
function Navbar({scroll1, scroll2}) {
  ...
  return (
    <div className='w-[363px] md:w-full h-[34px] md:h-[74px] md:pt-[10px] md:pb-[10px] md:pr-[64px] md:pl-[64px] pt-[5px] pb-[5px] pr-[20px] pl-[20px]  flex justify-between items-center relative'>
